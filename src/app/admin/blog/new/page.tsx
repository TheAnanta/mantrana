        ...
        >
          <div className="h-full flex flex-col font-montserrat">
            <div className="p-8 border-b border-charcoal/5 flex items-center justify-between">
              <h3 className="text-[11px] font-bold text-charcoal/30 uppercase tracking-[0.25em]">Post Meta</h3>
            ...
            <div className="flex-1 overflow-y-auto p-10 space-y-12">
              ...
              <div className="pt-4">
                <h3 className="text-[10px] font-bold text-charcoal/40 uppercase tracking-widest mb-4">Cover Artwork</h3>
                <div className="relative group">
                  {imagePreview ? (
                    ...
                    <label className="flex flex-col items-center justify-center aspect-[16/10] rounded-3xl border-2 border-dashed border-charcoal/10 hover:border-teal/40 hover:bg-teal/5 transition-all cursor-pointer group/upload">
                      ...
                      <span className="text-[10px] font-bold text-charcoal/30 uppercase tracking-[0.2em] group-hover/upload:text-teal transition-all">Click to Upload Cover</span>
              ...
              <div>
                <label className="block text-[10px] font-bold text-charcoal/40 uppercase tracking-widest mb-3">SEO Excerpt</label>
                <textarea 
                  value={excerpt}
            ...
            <div className="p-10 border-t border-charcoal/5">
               <div className="flex items-center space-x-3 text-charcoal/20">
                 ...
                 <div className="flex flex-col">
                   <span className="text-[10px] font-bold text-charcoal/40 uppercase tracking-widest">Author</span>
