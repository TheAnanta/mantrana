...
export default function AdminDashboard() {
  ...
  const recentActivity = [
    { type: 'appointment', message: 'New appointment booked by Sarah M.', time: '2 hours ago' },
    { type: 'testimonial', message: 'Testimonial submitted by Raj K.', time: '4 hours ago' },
    { type: 'blog', message: 'Blog post "Managing Anxiety" published', time: '1 day ago' },
    { type: 'contact', message: 'New contact form submission', time: '2 days ago' },
  ]
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="bg-gradient-to-r from-moss to-moss/80 rounded-lg p-6 text-white">
        ...
        <p className="text-moss-100">Here's what's happening with your practice today.</p>
      </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
        ...
        <div className="bg-white rounded-lg p-6 shadow-soft">
          <div className="flex items-center">
            ...
            <div className="ml-4">
              <p className="text-sm font-medium text-gray-600">New Clients (30d)</p>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
        ...
        <div className="bg-white rounded-lg p-6 shadow-soft">
          ...
          <div className="mt-4 pt-4 border-t border-gray-200">
            <Link href="/admin/analytics" className="text-sm text-moss font-medium hover:text-moss/80">
              View all activity →
            </Link>
          </div>
        </div>
      ...
      <div className="bg-white rounded-lg p-6 shadow-soft">
        ...
        <div className="space-y-3">
          <div className="flex items-center justify-between p-3 bg-gray-50 rounded-lg">
            <div>
              <p className="font-medium text-gray-900">Sarah M. - Individual Therapy</p>
              <p className="text-sm text-gray-600">Anxiety management session</p>
            </div>
            <span className="text-sm font-medium text-moss">10:00 AM</span>
          </div>
          <div className="flex items-center justify-between p-3 bg-gray-50 rounded-lg">
            <div>
              <p className="font-medium text-gray-900">John D. - Life Coaching</p>
              <p className="text-sm text-gray-600">Career transition planning</p>
            </div>
            <span className="text-sm font-medium text-moss">2:00 PM</span>
          </div>
          <div className="flex items-center justify-between p-3 bg-gray-50 rounded-lg">
            <div>
              <p className="font-medium text-gray-900">Couples Session - Ram & Sita</p>
        ...
        <div className="mt-4 pt-4 border-t border-gray-200">
          <Link href="/admin/appointments" className="text-sm text-moss font-medium hover:text-moss/80">
            View full calendar →
          </Link>
        </div>
      </div>
