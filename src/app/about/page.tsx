          ...
          <div className="max-w-4xl mx-auto space-y-8">
            {[
              ...
              },
              {
                ...
                answer:
                  "The first 30-minute session costs just ₹299 — a space to understand what brings you here and plan your therapy journey. After that, pricing varies based on the depth of the issue and the mode of therapy. Online sessions are slightly lower, while in-person sessions may differ to include space and resource costs.",
              },
              {
