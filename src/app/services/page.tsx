...
export const metadata = {
  ...
  description:
    "Comprehensive therapy, counselling, and coaching services. Individual therapy, life coaching, group workshops, and specialized programs for mental wellness.",
};
  ...
  const services = [
    {
      ...
      icon: "🧠",
      description:
        "Personalized one-on-one sessions to address your specific mental health needs and personal growth goals.",
      features: [
      ...
      approach:
        "Using evidence-based approaches including Cognitive Behavioral Therapy (CBT), Mindfulness-Based Therapy, and Person-Centered Therapy.",
    ...
    },
    {
      ...
      icon: "🎯",
      description:
        "Goal-oriented coaching to help you achieve personal and professional success while maintaining balance.",
      features: [
      ...
      approach:
        "Solution-focused coaching methodology combined with positive psychology principles and practical action planning.",
    ...
    },
    {
      ...
      icon: "👥",
      description:
        "Interactive group sessions focusing on specific themes and skill development in a supportive environment.",
      features: [
      ...
      approach:
        "Experiential learning through group discussions, practical exercises, and peer support.",
    ...
    },
    {
      ...
      icon: "📋",
      description:
        "Comprehensive, multi-session programs designed for specific needs and deeper transformation.",
      features: [
      ...
      approach:
        "Structured programs combining multiple therapeutic modalities with ongoing support and progress tracking.",
  ...
  const packages = [
    {
      ...
      price: "₹2,500",
      description:
        "Perfect for trying our services or addressing specific immediate concerns.",
      features: [
        "50-minute session",
        "Follow-up resources",
    ...
    },
    {
      ...
      originalPrice: "₹7,500",
      description:
        "Ideal for focused work on specific goals or short-term support.",
      features: [
    ...
    },
    {
      ...
      description:
        "Comprehensive support for deeper exploration and lasting change.",
      features: [
        ...
        <div className="container-custom">
          <div className="max-w-4xl mx-auto text-center">
            <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold text-gray-900 mb-6">
              ...
              <span className="text-[#D56989]">Services</span>
            </h1>
            <p className="text-xl md:text-2xl text-gray-600 leading-relaxed">
              Comprehensive mental health and wellness solutions tailored to
              your unique journey
            </p>
          </div>
        </div>
        ...
        <div className="container-custom">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-600 max-w-2xl mx-auto leading-relaxed">
              ...
              packages include ongoing support and resources.
            </p>
          </div>
            ...
            {[
              {
                ...
                description:
                  "Free 15-minute discovery call to understand your needs and answer questions.",
              },
              {
                step: "02",
                title: "Personalized Plan",
                description:
                  "We create a tailored approach based on your goals and preferences.",
              },
              {
                step: "03",
                title: "Begin Sessions",
                description:
                  "Start your journey with regular sessions and ongoing support.",
              },
              {
                step: "04",
                title: "Track Progress",
                description:
                  "Monitor your growth and adjust the approach as needed.",
              },
            ].map((item, index) => (
      ...
      <section className="section-padding bg-gradient-to-r from-moss to-citron">
        <div className="container-custom text-center">
          ...
          <p className="text-xl text-white/90 max-w-2xl mx-auto mb-12 leading-relaxed">
            ...
            growth. Book your session today or start with a free consultation.
          </p>
