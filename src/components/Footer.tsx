...
const navigation = {
  ...
  social: [
    { name: 'Instagram', href: '#', icon: 'M12.017 0C5.396 0 .029 5.367.029 11.987c0 6.62 5.367 11.987 11.988 11.987s11.987-5.367 11.987-11.987C24.004 5.367 18.637.001 12.017.001zM8.449 16.988c-1.297 0-2.448-.611-3.197-1.559-.748-.948-.748-2.229 0-3.177.749-.948 1.9-1.559 3.197-1.559s2.448.611 3.197 1.559c.748.948.748 2.229 0 3.177-.749.948-1.9 1.559-3.197 1.559z' },
      ...
      <div className="container-custom py-16 lg:py-20">
        <div className="grid grid-cols-1 lg:grid-cols-4 gap-12">
          ...
          <div className="lg:col-span-2">
            <div className="text-3xl font-bold text-moss mb-4">
              Mantrana
            </div>
            <p className="text-gray-600 text-lg leading-relaxed mb-6 max-w-md">
              Professional therapy, counselling, and coaching services by Mohana Rupa. 
              Your journey to mental wellness and inner clarity begins here.
            </p>
            <div className="text-sm text-gray-500">
              <p className="mb-2">&copy; 2024 Mantrana by Mohana Rupa. All rights reserved.</p>
