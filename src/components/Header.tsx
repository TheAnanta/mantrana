    ...
    <header className={`fixed top-0 w-full z-50 shadow-sm bg-background transition-all`}>
      ...
      <nav className="container-custom">
        <div className="flex items-center justify-between h-16 lg:h-20">
          {/* Logo */}
          <Link href="/" className="flex-shrink-0 flex flex-col items-start leading-none py-1">
            <svg
            ...
            <span className="text-[7.5px] font-montserrat tracking-widest text-charcoal/50 mt-1 font-semibold uppercase">
              UDYAM-AP-10-0134480
            </span>
          </Link>
